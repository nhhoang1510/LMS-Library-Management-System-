...
<body>
	...
	<div class="hello">
		...
		<h5 class="text-center"> <b><i>Xem và quản lý danh sách sách trong thư viện</i></b></h5>
	</div>
		...
		<div class="table-responsive">
			<table class="table table-hover">
				...
				<tbody>
					...
					// 	$query .= " WHERE book_name LIKE '%$search%' OR book_author LIKE '%$search%' OR book_category LIKE '%$search%'";
					// }
					
					$query_run = mysqli_query($connection, $query);
					while ($row = mysqli_fetch_assoc($query_run)) {
						$category_query = "SELECT cat_name FROM category WHERE cat_id = ".$row['book_category'];
						...
						<tr>
							...
							<td>
								<a href="edit_book.php?bn=<?php echo $row['book_name']; ?>" class="btn btn-edit btn-action">Sửa</a>
								<a href="delete_book.php?bn=<?php echo $row['book_name']; ?>" class="btn btn-delete btn-action">Xóa</a>
							</td>
						</tr>
						<?php
					}
